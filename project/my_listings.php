...
if(isset($_POST['delete'])){
   ...
   if($verify_delete->rowCount() > 0){
      ...
      $success_msg[] = 'Listagem excluida!';
   }else{
      $warning_msg[] = 'Listagem ja excluida!';
   }
...
<head>
   ...
   <title>Minhas listagens - Casas Aqui</title>
...
<section class="my-listings">
   ...
   <h1 class="heading">Minhas listagens</h1>
   ...
   <form accept="" method="POST" class="box">
      ...
      <div class="flex-btn">
         ...
         <input type="submit" name="delete" value="Excluir" class="btn" onclick="return confirm('Excluir esta listagem?');">
      </div>
      <a href="view_property.php?get_id=<?= $property_id; ?>" class="btn">Ver propriedades</a>
   </form>
   <?php
         }
      }else{
         echo '<p class="empty">Nenhuma propriedade adicionada ainda! <a href="post_property.php" style="margin-top:1.5rem;" class="btn">Adicionar nova</a></p>';
      }
      ?>
