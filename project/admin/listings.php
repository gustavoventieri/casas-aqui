...
if(isset($_POST['delete'])){
   ...
   if($verify_delete->rowCount() > 0){
      ...
      $warning_msg[] = 'Listagem já excluida!';
   }
...
<section class="listings">
   ...
   <h1 class="heading">Todas Listagens  - Casas Aqui</h1>

   <form action="" method="POST" class="search-form">
      <input type="text" name="search_box" placeholder="Buscar por listagens..." maxlength="100" required>
   ...
   <div class="box">
      ...
      <form action="" method="POST">
         ...
         <input type="submit" value="Excluir listagem" onclick="return confirm('Excluir esta lisatgem?');" name="delete" class="delete-btn">
      </form>
   </div>
   <?php
         }
         ...
         echo '<p class="empty">Nenhuma propriedade adicionada ainda!</p>';
      }
   ?>
