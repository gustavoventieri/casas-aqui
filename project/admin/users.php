...
if(isset($_POST['delete'])){
   ...
   if($verify_delete->rowCount() > 0){
      ...
      $success_msg[] = 'Usuario excluido!';
   }else{
      $warning_msg[] = 'Usuario já foi excluido!';
   }
...
<head>
   ...
   <title>Usuarios Cliente - Casas Aqui</title>
...
<section class="grid">
   ...
   <form action="" method="POST" class="search-form">
      <input type="text" name="search_box" placeholder="Procurar usuarios..." maxlength="100" required>
   ...
   <div class="box">
      ...
      <form action="" method="POST">
         ...
         <input type="submit" value="Excluir Usuario" onclick="return confirm('Excluir este usuario?');" name="delete" class="delete-btn">
      </form>
   </div>
   <?php
      }
      ...
      echo '<p class="empty">Nenhum usuario foi adicionado ainda!</p>';
   }
   ?>
