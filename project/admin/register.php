...
<section class="form-container">
   ...
   <form action="" method="POST">
      ...
      <input type="text" name="name" placeholder="Digite o username" maxlength="20" class="box" required oninput="this.value = this.value.replace(/\s/g, '')">
