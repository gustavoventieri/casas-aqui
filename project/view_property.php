...
<head>
   ...
   <title>Ver propriedades - Casas Aqui</title>
...
<section class="view-property">
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <div class="info">
         <p><span style = "color:#2980b9;">R$</span><span> <?= number_format($fetch_property['price'] ,2,",",".");?></span></p>
      ...
      <div class="flex">
         <div class="box">
            ...
            <p><i>Deposito : </i><span>R$ <?=number_format($fetch_property['deposite'] ,2,",","."); ?></span></p>
   ...
   <?php
      ...
      echo '<p class="empty">Propriedade não encostrada<a href="post_property.php" style="margin-top:1.5rem;" class="btn">add new</a></p>';
   }
   ?>
