...
<head>
   ...
   <title>Todas listagens - Casas Aqui</title>
...
<section class="listings">
   ...
   <h1 class="heading">Todas listagens</h1>
   ...
   <div class="box-container">
      ...
      <form action="" method="POST">
         ...
         <div class="box">
            <div class="price"><span style = "color:#2980b9;">R$</span><span> <?= number_format($fetch_property['price'] ,2,",",".");?></span></div>
